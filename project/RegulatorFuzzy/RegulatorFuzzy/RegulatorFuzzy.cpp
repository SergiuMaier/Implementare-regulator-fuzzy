...
int main()
{
	...
	std::cout << "Valoarea erorii (din intervalul [-1,1]):" << std::endl;
	std::cout << "e = ";
	std::cin >> e;

	std::cout << "Valoarea derivatei erorii (din intervalul [-1,1]): " << std::endl;
	std::cout << "de = ";
	std::cin >> de;
	std::cout << std::endl;
	...
	std::cout << "Apartenenta eroare." << std::endl;
	...
	std::cout << "Apartenenta derivata eroare" << std::endl;
	...
	std::cout << std::endl;
	std::cout << "Defuzificare = " << CalculDefuzificare(iesire[0], iesire[1], iesire[2], iesire[3],iesire[4], c1, c2, c3, c4, c5) << std::endl;
